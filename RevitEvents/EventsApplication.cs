    ...
    public class EventsApplication : IExternalApplication
    {
        ...
        private void appDocOpened(object sender, Autodesk.Revit.DB.Events.DocumentOpenedEventArgs e)
        {
            ...
            try
            {
                ...
                Slack.Settings ds = JsonConvert.DeserializeObject<Slack.Settings>(st);
            ...
            if (Variables.slackOn)
            {
                ...
                if (patheq && Variables.logIsWorkshared)
                {
                    ...
                    string icon_url = Variables.icon_revit_slacker;
            ...
            if (Variables.slackOn)
            {
                ...
                if (fileInfo.AllLocalChangesSavedToCentral == false)//Variables.logChangesSaved == false)
                {
                    ...
                    var attachments = new Attachments
                    {
                        ...
                        image_url = gif_url
                            //image_url = Constants.image_url_shakefist
            ...
            public static class Collectors
        {
            ...
            #region EXAMPLES: Slack Post
/*Example Slack post format
 * 
 * 
 * 
            if (Variables.slackReady && Variables.slackSynch)
            {
                //Create client
